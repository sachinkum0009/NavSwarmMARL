...
class TestTwistPidController(unittest.TestCase):
    ...
    def test_linear_only_update(self):
        ...
        self.assertIsInstance(output, float)
        expected = self.linear_params.kp * (1.0 - 0.8)  # Proportional only for this simple case
        self.assertEqual(output, expected)
    ...
    def test_angular_only_update(self):
        ...
        self.assertIsInstance(output, float)
        expected = self.angular_params.kp * (0.5 - 0.3)  # Proportional only for this simple case
        self.assertEqual(output, expected)
